	...
	<Html>
		...
		<Body style={main}>
			<Container style={container}>
				<Img
					src='https://res.cloudinary.com/da1hth9pf/image/upload/v1708295295/54795_soft_2_copy_fe1a97e725.jpg'
					width="320"
					height="420"
					alt="Koala"
					style={logo}
				...
				<Text style={paragraph}>
					Thank you purchasing on Hassan Tech Ecommerce. Click on Below download button to download the all digital content
				</Text>
